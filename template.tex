...
\subsection{fhqtreap}
\lstinputlisting{./数据结构/fhqtreap.cpp}
\subsection{fhqtreap（区间操作）}
\lstinputlisting{./数据结构/fhqtreap（区间操作）.cpp}
\subsection{树链剖分}
\lstinputlisting{./数据结构/树链剖分.cpp}
\subsection{主席树}
\lstinputlisting{./数据结构/主席树.cpp}
\subsection{线段树分裂}
\lstinputlisting{./数据结构/线段树分裂.cpp}
\subsection{LCA}
\lstinputlisting{./数据结构/LCA.cpp}
\section{其他}
\subsection{二分}
\lstinputlisting{./其他/二分.cpp}
\subsection{template}
\lstinputlisting{./其他/template.cpp}
\end{document}